                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3 mb-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            ...
                                            <input type="file" name="vouguepay_image" id="image-upload" />
                                        </div>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="vouguepay_merchant_id" class="form-control"
                                                    value="{{ @$gateway->gateway_parameters->vouguepay_merchant_id ?? old('vouguepay_merchant_id') }}">
                                            </div>
