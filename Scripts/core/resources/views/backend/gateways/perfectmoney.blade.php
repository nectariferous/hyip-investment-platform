                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="accountid" class="form-control"
                                            value="{{ @$gateway->gateway_parameters->accountid ?? old('accountid') }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="passphrase" class="form-control"
                                            value="{{ @$gateway->gateway_parameters->passphrase ?? old('passphrase') }}">
                                    </div> 
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <select name="status" id="" class="form-control selectric">
                                            ...
                                            <option value="0" {{ @$gateway->status ? '' : 'selected' }}>{{__('No')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary float-right">{{__('Update stripe Information')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
