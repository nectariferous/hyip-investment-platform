                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            ...
                                            <input type="file" name="paystack_image" id="image-upload" />
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="paystack_key" class="form-control"
                                                    value="{{ @$gateway->gateway_parameters->paystack_key ?? old('paystack_key') }}">
                                            </div> 
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary float-right">{{ __('Update Paystack Information') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
