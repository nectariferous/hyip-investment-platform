                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            ...
                                            <input type="file" name="flutter_image" id="image-upload" />
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="reference_key" class="form-control"
                                                    value="{{ @$gateway->gateway_parameters->reference_key ?? old('reference_key') }}">
                                            </div>
