                    ...
                    <form action="{{ route('user.reset.password') }}" method="POST">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-md-12">
                                <label for="" class="text-secondary mt-2 mb-2">{{ __('New Password') }}</label>
                                <input type="password" name="password" class="form-control" placeholder="Enter new password">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="" class="text-secondary mb-2 mt-2">{{ __('Confirm Password') }}</label>
                            ...
                            <div class="col-md-12">
                                <button type="submit" id="recaptcha"
                                    class="sp_theme_btn mt-3 w-100">{{ __('Reset Password') }}</button>
                            </div>
                            <div class="col-md-12 mt-4 text-center">
                                <p>{{ __('Login Again') }}? <a href="{{ route('user.login') }}"
                                    class="color-change"  >{{ __('Login') }}</a></p>
                            </div>
                        </div>
                    </form>
                </div>
