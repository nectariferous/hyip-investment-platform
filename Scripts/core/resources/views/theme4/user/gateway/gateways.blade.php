                ...
                <div class="col-xxl-2 col-lg-3 col-sm-4 col-6">
                    <div class="payment-box text-center">
                        ...
                        <div class="payment-box-content">
                            ...
                            <button data-href="{{ route('user.paynow', $gateway->id) }}" data-id="{{ $gateway->id }}" class="btn main-btn w-100 paynow mt-3"><span>{{ __('Pay Now') }}</span></button>
                        </div>
                    </div>
                </div>
            @empty
            ...
            <form action="" method="post">
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn main-btn"><span>{{ __('Deposit Now') }}</span></button>
                    </div>
                </div>
            </form>
        </div>
