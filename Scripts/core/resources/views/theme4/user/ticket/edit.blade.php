                ...
                <div class="card card-wrapper">
                    <form action="{{ route('user.ticket.update', $ticket->id) }}" class="p-3" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="subject" class="form-control sp_bg_dark" required="" placeholder="" value="{{ $ticket->subject }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="mb-2">{{ __('Priority') }}</label>
                                    <select class="form-select selectric sp_bg_dark" name="priority">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control sp_bg_dark" id="exampleFormControlTextarea1" rows="3" name="message">{{ $ticket_reply->message }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="custom-file mt-3 col-md-6">
                                ...
                                style="background-image: url({{ getFile('Ticket', $ticket_reply->file) }});">
                                    ...
                                    <input type="file" class="form-control sp_bg_dark" name="file" id="image-upload" />
                                </div>
                            </div>
                        </div>
