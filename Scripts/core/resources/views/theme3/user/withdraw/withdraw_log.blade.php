                ...
                <div class="text-center mb-4">
                    <div class="tab-btn-group">
                        <a class="tab-btn {{ Request::routeIs('user.withdraw.all') ? 'active' : '' }}"
                            href="{{ route('user.withdraw.all') }}">{{ __('All') }} <span class="d-sm-inline-block d-none">{{ __('Withdraw') }}</span></a>

                        <a class="tab-btn {{ Request::routeIs('user.withdraw.pending') ? 'active' : '' }}"
                            href="{{ route('user.withdraw.pending') }}">{{ __('Pending') }} <span class="d-sm-inline-block d-none">{{ __('Withdraw') }}</span></a>

                        <a class="tab-btn {{ Request::routeIs('user.withdraw.complete') ? 'active' : '' }}"
                            href="{{ route('user.withdraw.complete') }}">{{ __('Complete') }} <span class="d-sm-inline-block d-none">{{ __('Withdraw') }}</span></a>
                    </div>
                </div>
