            ...
            <div class="card-header">
                <div class="row gy-4"> 
                    ...
                    <div class="col-md-4  text-md-end text-center">
                        <button id="new-ticket" class="btn main-btn btn-sm">{{ __('Create Ticket') }} <i class="fa fa-envelope"
                ...
                <div class="modal-content bg-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn main-btn">{{ 'Create Ticket' }}</button>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <div class="modal-content bg-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">{{ __('Close') }}</button>
                                <button type="submit" class="btn main-btn">{{ 'Update Ticket' }}</button>
                            </div>
                        </div>
                    </div>
                </form>
